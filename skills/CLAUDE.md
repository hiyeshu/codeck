...
- 2026-03-30: codeck-design + codeck-review: element scale rules — visual elements must use relative units (vw/vh/%/clamp), not fixed small px. Design checklist and review both check for undersized multi-element layouts. Deliberate breathing pages exempted.
