...
读取 `$HOME/.claude/skills/codeck-outline/checklist.md`，逐项检查 `$DECK_DIR/outline.md` 和 `$DECK_DIR/intent.md`。
...
显示简版 pipeline 进度：
```
outline [done] → design [ready] → review → export → speech
下一步：/codeck-design
```
